  ...
  public Result addProductIssue(Integer productId) {
    ...
    try {
      ...
      for (int i = 0; i < issueCategoryList.size(); i++) {
        ...
        List<IssueReason> issueReasonList =
                issueReasonRep.getByCategoryId(issueCategoryList.get(i).getId());
  ...
  public Result AddNewProductIssueCategory(Integer productId) {
    ...
    try {
      ...
      for (IssueReason reason : listCommReason) {
        ...
        newCategoryId =
                IssueFactory.findAppropriateCategoryId(categoryId, listCommCategory, listNewCategory);
