	...
	result = {
			...
			"cd":{
				...
				"columns": [
					...
					{"key":"coldemo","label":"UI Info","type":"uilink","align":1,"field":"uiinfo","formatter":"/#/buy/index?token={token}&page={page}"},
				...
				"fields": ["id","page","key","type","data","is_required","en_us","zh_cn","dueDate","progress", "qa", "uiinfo"],
				"data": [
					[1,"Product","name","text",null,1,"Project Name","Name_cn","2019-07-09 16:20:18", 0.1234,0, "uiinfo1"],
					[2,"Product","projectOwner","refUser","{\"userId\":1,\"userName\":\"Kevin\",\"email\":\"kevin@symbio.com\",\"avatar\":\"http://www.baidu.com\"}",1,"Owner","Owner_cn","2019-07-10 16:20:18", 0.1,1, "uiinfo2"],
					[3,"Product","dueDate","calendar",null,0,"Due Date","dueDate_cn","2019-07-11 16:20:18", 1,2, "uiinfo3"],
					[4,"Product","Progress","number",null,1,"Progress","进度","2019-07-12 16:20:18", 0,3, "uiinfo4"],
					[5,"Product","QAStatus","text",null,0,"QAStatus","QA状态","2019-07-15 16:16:16", null, null, "uiinfo5"]
				]
			}
	}
