...
<div>
    <el-card class="manage-tabel" shadow="never">
        ...
        <el-table :data="productList" align="center">
            <p>{{productList}}</p>
            <el-table-column prop="name" align="center" :label="$t('testManagement.name')" :width="0.5*tabelWidth">
