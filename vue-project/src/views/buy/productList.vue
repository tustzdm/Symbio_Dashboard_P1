        ...
        <el-table :data="productList" >
            <el-table-column prop="name" :label="$t('testManagement.name')" :width="0.5*tabelWidth" align="center">
                <template slot-scope="scope">
                    <div>
                        <router-link :to="{ name: 'productInfo', query: { productId:scope.row.id}}">{{scope.row.name}}</router-link>
                    </div>
                    <div>{{scope.row.description}}</div>
                </template>
            </el-table-column>
            <el-table-column prop="progress" :label="$t('testManagement.progress')" align="center" :width="0.25*tabelWidth">
                <template slot-scope="scope">
