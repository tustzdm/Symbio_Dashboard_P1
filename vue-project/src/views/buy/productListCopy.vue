            ...
            <el-table-column prop="progress" label="Progress" :width="0.25*tabelWidth">
                <template slot-scope="scope">
                    <div style="float:left;border:1px solid white;width:80%;height:100%;border-radius:10px;background-color:#e8ebf1">
                        <div v-bind:style="{width:scope.row.progress}" style="float:left;background-color:#b1c9f7;border-radius:10px 0 0 10px">{{scope.row.finished}}</div>
                        {{scope.row.all}}
                    </div>
                    {{scope.row.progress}}
    ...
    data() {
        return {
            ...
            tableData: [{
                    ...
                    finished: 300,
                    all: 342,
                    description: 'Description of product1, for nomal account ,function and performance test'
                },
                {
